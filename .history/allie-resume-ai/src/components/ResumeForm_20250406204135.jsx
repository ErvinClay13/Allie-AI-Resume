          ...
          <form onSubmit={handleSubmit} className="resume-form">
            <div className="infoContainer">
              <div className="userInfo">
                ...
                <p>Please enter the positon that you are applying for.</p>
                ...
                {/* <p>Please enter details about you education.  <br />
            ...
            <p>Please enter a career objective(s)</p>
            ...
            <p>Please enter your experience in the field that you are applying for.</p>
            <div className="experienceField">
              ...
              <p>Please enter your skills for this position <br />
