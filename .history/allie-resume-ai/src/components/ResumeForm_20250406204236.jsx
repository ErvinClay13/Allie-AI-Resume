          ...
          <form onSubmit={handleSubmit} className="resume-form">
            <div className="infoContainer">
              <div className="userInfo">
                ...
                <p className="formInstructions">Please enter your full name.</p>
                ...
                <p className="formInstructions">Please enter your phone number.</p>
                ...
                <p className="formInstructions">Please enter your email address.</p>
                ...
                <p className="formInstructions">Please enter the positon that you are applying for.</p>
                ...
                {/* <p className="formInstructions">Please enter details about you education.  <br />
                -Example: School Name, Years attended, Degrees etc...</p> */}
                {/* <div className="education1Field">
                  <textarea
                  name="education1"
            ...
            <p className="formInstructions">Please enter a career objective(s)</p>
            ...
            <p className="formInstructions">Please enter your experience in the field that you are applying for.</p>
            <div className="experienceField">
              ...
              <p className="formInstructions">Please enter your skills for this position <br />
              and Allie will place them in a unordered list!</p>
